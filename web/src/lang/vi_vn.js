export default {
  ...
  saveImage: {
    title: 'Lưu hình ảnh',
    options: 'Tùy chọn lưu',
    type: 'Loại lưu',
    single: 'Nút đơn lẻ',
    all: 'Tất cả hình ảnh',
    selected: 'Nút đã chọn',
    format: 'Định dạng',
    compression: 'Chất lượng nén',
    size: 'Kích thước',
    exportOptions: 'Tùy chọn xuất',
    includeText: 'Bao gồm văn bản',
    transparentBg: 'Nền trong suốt',
    highQuality: 'Chất lượng cao',
    preview: 'Xem trước',
    originalSize: 'Kích thước gốc',
    fileSize: 'Dung lượng',
    compressedSize: 'Kích thước sau nén',
    noActiveNode: 'Vui lòng chọn một nút',
    noImagesFound: 'Không tìm thấy hình ảnh',
    noSelectedImages: 'Không có hình ảnh đã chọn',
    previewError: 'Tạo xem trước thất bại',
    save: 'Lưu',
    saveSuccess: 'Lưu thành công',
    saveError: 'Lưu thất bại',
    defaultFileName: 'Hình ảnh sơ đồ tư duy'
  },
  directory: {
    saving: 'Đang lưu…',
    saved: 'Đã lưu',
    saveError: 'Lưu thất bại',
    idle: 'Thư mục làm việc'
  },
  edit: {
