    ...
    <div class="toolbar" ref="toolbarRef">
      ...
      <div class="toolbarBlock">
        ...
        <el-tooltip
          ...
          effect="dark"
          :content="directoryTooltip"
          placement="bottom"
        >
          <div class="directoryStatusBar" :class="directorySaveStatus">
            <span class="dirStatusIcon el-icon-folder"></span>
            <span class="dirStatusText">{{ directoryStatusText }}</span>
          </div>
        </el-tooltip>
        ...
        <div
          class="toolbarBtn"
          @click="$bus.$emit('showSaveImage')"
          style="margin-right: 0;"
        >
          <span class="icon iconfont iconbaocun"></span>
          <span class="text">{{ $t('toolbar.saveImage') }}</span>
        </div>
        <!-- 本地文件树 -->
        <div
          class="fileTreeBox"
...
export default {
  ...
  computed: {
    ...mapState({
      ...
      directorySaveStatus: state => state.directorySaveStatus,
    ...
    directoryStatusText() {
      ...
      return map[this.directorySaveStatus] || this.$t('directory.idle')
    },

    directoryTooltip() {
      if (!this.isDirectoryMode) return ''
      return (this.directoryName || '') + ' · ' + this.directoryStatusText
    },
